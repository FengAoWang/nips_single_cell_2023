...
class CPATrainingPlan(TrainingPlan):
    def __init__(
        ...
        self.metrics = ['recon_loss', 'KL',
                        ...
                        'r2_mean', 'r2_var',
                        'adv_loss', 'penalty_adv', 'adv_perts', 'acc_perts', 'penalty_perts','mrrmse']
    ...
    def training_step(self, batch, batch_idx):
        ...
        mrrmse = self.module.mrrmse(batch, inf_outputs, gen_outputs)
    ...
    def training_epoch_end(self, outputs):
        ...
        self.log("mrrmse", self.epoch_history['mrrmse'][-1], prog_bar=True)
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log('val_mrrmse', self.epoch_history['mrrmse'][-1], prog_bar=True)
        ...
        if self.current_epoch % self.n_epochs_verbose == self.n_epochs_verbose - 1:
            ...
            print(f'val_mrrmse = {self.epoch_history["mrrmse"][-1]}')
